...
import com.maggnet.ui.home.fragment.qrcode.scan.QRCodeScannerCallback;
import com.maggnet.utils.codescanner.AutoFocusMode;
import com.maggnet.utils.codescanner.DecodeCallback;
import com.maggnet.utils.codescanner.DecoderWrapper;
import com.maggnet.utils.codescanner.ErrorCallback;
import com.maggnet.utils.codescanner.Point;
import com.maggnet.utils.codescanner.ScanMode;
...
public final class CodeScanner {
    ...
    private volatile int mCameraId = CAMERA_FRONT;
    ...
    public volatile QRCodeScannerCallback qrCodeScannerCallback = null;
    ...
    public void setAutoFocusEnabled(final boolean autoFocusEnabled) {
        synchronized (mInitializeLock) {
            ...
            mScannerView.setAutoFocusEnabled();
            final DecoderWrapper decoderWrapper = mDecoderWrapper;
